...
(function (root) {
     ...
     * @property {SubViewManager} subs Object specifically for manipulating subviews
     * @property {object} subViewConfig A config map that can be automatically passed to the SubViewManager
     * @property {boolean} autoInitSubViews Any subviews that are singletons will be auto-initialized if true
